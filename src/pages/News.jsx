      ...
      <div className="max-w-5xl mx-auto">
        ...
        {news.length === 0 ? (
          <div className="text-center py-20">
            <p className="text-3xl text-textDark/60 font-light">No news yet... but our story is always unfolding</p>
          </div>
        ) : (
            ...
            {news.map((item, index) => (
              ...
              >
                ...
                <div className="p-10 md:p-16">
                  <h2 className="text-4xl md:text-5xl font-extrabold text-textDark mb-8">{item.title}</h2>
                  <p className="text-textDark/80 text-xl leading-relaxed whitespace-pre-line">{item.content}</p>
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-primary text-center mb-12">Board Meeting Minutes</h2>
        ...
        {role === 'admin' && (
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-primary text-center mb-12">Share a New Story</h2>
